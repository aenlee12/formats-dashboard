...
def main():
    ...
    if test_mode:
        ...
        sum_rev_pre, sum_rev_post = df_pre['Выручка'].sum(), df_post['Выручка'].sum()
...
"""
    ...
    # Отображаем тренды без тестового разделителя
